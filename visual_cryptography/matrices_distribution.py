...
from visual_cryptography.basis_generation import BasisMatrices
import visual_cryptography.util as util
...
def distribute_matrices(img_message,
    ...
    img_share = np.zeros((num_share, *output_shape), dtype=int)
